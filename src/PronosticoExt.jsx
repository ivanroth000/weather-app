...
export const PronosticoExt = ({
  ...
  setExtendido,
  difVisibility,
  enviarAlPadrePronosticoExtendido,
}) => {
    ...
    <>
      <div className="mx-4  containerExtendido">
        {prox5Dias.map((item, index) => {
          ...
          return (
            <div
              className={`container mx-2 pt-5 cardExtendido cardExtendido-${index}`}
              key={index}
            >
              <h1 className="meteorologicalConditionsExtendido">{fecha}</h1>
              <div className="cityIcon">
                <img
                  className="iconWeatherExtendido"
              ...
              <p className="meteorologicalConditionsExtendido">
                Condición meteorológica: {weatherDescription}
              </p>
              <div className="subIconExtendido">
                <img
                  ...
                  alt="Humedad"
                />
                <p className="mt-2 fw-bold">Humedad: {humedad}%</p>
              </div>
              <div className="subIconExtendido">
                <img
                  className="iconVisibility  mb-3"
                  src={imagenes.img5}
                  alt="Visibilidad"
                />
                <p className="mt-3 ms-2 fw-bold">
                  Visibilidad: {visibilidad / difVisibility}km
                </p>
              </div>
            </div>
          );
